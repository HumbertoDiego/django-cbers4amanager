...
CBERS4A : B4(nir),B3(red),B2(green),B1(blue)
Whitness Index  (WI) : Diminui a importância das bandas que sofrem mais com efeito atmosférico, apenas os pixels 
M = 0.25*blue+0.375*green+0.375*red
WI = |blue-M|/M + |green-M|/M + |red-M|/M
MascaraWI = --calc='WI<{WImax}'
"""
