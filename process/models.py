...
class Task(models.Model):
    ...
    interpreter = models.CharField(_("interpreter"), max_length=200, blank=True, null=True)
    arguments = models.CharField(_("arguments"), max_length=5000, blank=True, null=True)
